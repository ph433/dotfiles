function __fzf_search_directory_custom --description "Search the current directory (Custom version with 100% height)"
    ...
    # Các đoạn code phía dưới giữ nguyên vẹn hoàn toàn...
